...
/**
 * 2. GESTION DES ACTIONS (SUPPRESSION ET SAUVEGARDE)
 */

// Action : Suppression d'un abonnement
if (isset($_GET['action']) && $_GET['action'] == "supprimer" && isset($_GET['id'])) {
    $pdo->prepare("DELETE FROM abonnement WHERE id_ab = ?")->execute([intval($_GET['id'])]);
    header("Location: abonnemnts.php"); exit();
}

// Action : Ajout ou Modification d'un abonnement
...
<div class="main-content">
    ...
    <div class="content-container">
        <div class="form-section">
            ...
            <h3><?= $updateMode ? "Modifier la formule" : "Ajouter une nouvelle formule" ?></h3>
            ...
            <form method="POST">
                ...
                if ($updateMode) { echo " <a href='abonnemnts.php' class='btn-cancel'>Annuler</a>"; }
                ?>
            </form>
        </div>
        ...
        <div class="table-section">
            ...
            <div class="table-container">
                <table class="data-table">
                    <thead>
                        <tr><th>ID</th><th>Nom</th><th>Prix</th><th>Durée</th><th>Avantages</th><th>Actions</th></tr>
                    </thead>
                    <tbody>
