 ...
 */
session_start();
// Vérification si l'administrateur est connecté pour protéger l'accès
...
/**
 * 2. RÉCUPÉRATION DES STATISTIQUES (TOTAUX)
 */
// Utilisation de fetchColumn() pour récupérer directement le nombre total d'entrées
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            <div class="dashboard-cards">
                <?php 
                    // Génération dynamique des cartes de statistiques
